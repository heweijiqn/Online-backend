...
package com.hwj.classroom.live.mtcloud;


import com.hwj.classroom.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "61663";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "2ec00738b50f463150e93a75fb6fb96b";
