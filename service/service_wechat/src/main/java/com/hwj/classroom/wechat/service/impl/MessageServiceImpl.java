...
import com.hwj.classroom.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long orderId) {
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                ...
                .templateId("vrNRwBJZbpdAxz6ji17OhSrPsp6NYRN2uH-E_PYPPAw")//模板id
                .url("https://828p801z80.goho.co/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
